...
class Book(base):
    ...
    title = Column(String)
    author = relationship('Book_Authors', backref='books_book')
    language = relationship('Book_Languages', backref='books_book')
        ...
        for book in paginated_results.items:
            ...
            if book.language:
                for language in book.language:
                    languages.append(language.language.code)
            else:
                languages = None
            ...
            one_book['authors'] = authors
            one_book['languages'] = languages
